...
const[submittedData, submittedForm]= useState(null)
...
const checkFormInput = () =>{
  ...
  if(!validated.fName.trim()){
    newErrors.fName="First name is required";
  }
if(!validated.lName.trim()){
...
}else if(!passwordRegax.test(validated.password)){
  newErrors.password="Please enter a valid password"
}
if(!validated.confirmPassword){
  newErrors.confirmPassword="Please confirm your password"
}else if(validated.confirmPassword !== validated.password ){
  newErrors.confirmPassword="please enter the correct password"
}
...
const ConfirmSubmit=(e)=>{
  ...
  return(
    <div  className="mx-auto w-1/2 mt-20">
      ...
      {submittedData && (
        <div className="w-full bg-gray-200 p-4 rounded mt-4">
